...
//! real workers behave on ambiguous asks (quality, persona adherence, token/turn efficiency). It
//! drives the COMPILED `lila` binary (the project's
...
//! on-disk workspace and memory the workers left behind.
//!
//! Layering: everything here that is DETERMINISTIC — the grader
